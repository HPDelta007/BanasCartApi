...
public partial class API_Category : System.Web.UI.Page
{
    ...
    public string GetData()
    {
        ...
        try
        {
            ...
            //if (UserId != null)
            //{
            //    tempResult1 = itsDriver.fSelectAndFillDataSet(" SELECT CatalogId, Title, "+
            ...
            //    " from Catalogs where InsertedByUserid ='"+ UserId +"'"+
            //                    " ORDER BY InsertedOn DESC ", Dt);
            //}
            //else
            //{
            //    tempResult1 = itsDriver.fSelectAndFillDataSet(" SELECT CatalogId, Title, " +
            ...
            tempResult1 = itsDriver.fSelectAndFillDataSet(" SELECT s.Code As CatId, s.[Name] " +
                                                          " , replace(it.PhotoPath, '" + ConfigurationSettings.AppSettings["FolderPath"] + "', '" + ConfigurationSettings.AppSettings["FolderPathShow"] + "') as PhotoPath " +
                                                          " FROM SubGrps s " +
                                                          " inner join [Catalogs] c on c.[SubGrpId] = s.Code " +
                                                          " left join ItmPhotos it on it.ItmCode = s.Code " +
                                                          " ORDER BY s.Name ASC ", Dt);
