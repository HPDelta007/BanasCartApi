...
public partial class API_API_GetNewsLetters : System.Web.UI.Page
{
    ...
    public string GetData()
    {
        ...
        try
        {
            ...
            tempResult1 = itsDriver.fSelectAndFillDataSet(" select *, replace(FilePath, '" + ConfigurationSettings.AppSettings["FolderPath"] + "', '" + ConfigurationSettings.AppSettings["FolderPathShow"] + "') as FilePathShow " +
                                                          " from NewsLetters where isnull(IsDisabled, 0) = 0 order by InsertedOn desc ", Dt);
