...
public partial class API_API_GetSchemes : System.Web.UI.Page
{
    ...
    public string GetData()
    {
        ...
        try
        {
            ...
            //if (UserId != null)
            //{
            //    tempResult1 = itsDriver.fSelectAndFillDataSet(" select Title, Remarks, "+
            ...
            //                    " from Schemes s left join SchemeLns sl on sl.SchemeId= s.SchemeId " +
            //                    " where s.InsertedByUserId ='" + UserId + "'" +
            //                    " ORDER BY s.InsertedOn DESC ", Dt);
            //}
            //else
            //{
                tempResult1 = itsDriver.fSelectAndFillDataSet("  select Title, Remarks, " +
