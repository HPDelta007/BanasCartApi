...
public partial class API_GetSerialNoData : System.Web.UI.Page
{
    string SerialNo;
    string APIKey;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                if (Request.Form["SerialNo"] != null && Request.Form["SerialNo"] != "")
                    SerialNo = Request.Form["SerialNo"].ToString();
                else
                    SerialNo = null;
    ...
    public string selectdata()
    {
        ...
        try
        {
            da = _aPI_BLL.returnDataTable(" select * From vwSerialNoDetails where SerialNo = '" + SerialNo.ToString() + "'  ");
