...
public partial class API_UserValid : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                Response.Write(GetData(UserName, Password));
            }
            catch (Exception ex)
            {
                string sw = "";
    ...
    public string GetData(string MobileNo,string Password)
    {
        ...
        try
        {
            ...
            tempResult1 = itsDriver.fSelectAndFillDataSet(" select * from Users where MobileNo = '" + UserName + "'" +
            ...
            if (Dt == null)
            {
                ReturnVal = GetReturnValue("209", "Please use register mobile number to login.", st);
            }
            ...
            {
                ReturnVal = GetReturnValue("200", "Mobile number is valid.", st);
            }
