...
public partial class API_DeleteSoLns : System.Web.UI.Page
{
    string SOLnID;
    string APIKey;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                SOLnID = (((Request.Form["SOLnID"] != null && Request.Form["SOLnID"] != "")) ? Request.Form["SOLnID"].ToString() : null);
    ...
    public string selectdata()
    {
        ...
        try
        {
             ...
             _aPI_BLL.InsertUpdateNonQuery(" delete from SOLns where SOLnID  = " +
                                          "   " + ((SOLnID == null) ? "NULL" : "'" + SOLnID .ToString() + "'") + " ");

            da = _aPI_BLL.returnDataTable(" select 'Deleted'");
